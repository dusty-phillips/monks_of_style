...
pub fn webkit_box_reflect(value: WebkitBoxReflect) -> #(String, String) {
  #("-webkit-box-reflect", case value {
    Above -> "above"
    Below -> "below"
    Right -> "right"
    Left -> "left"
...
pub fn raw(value: String) -> #(String, String) {
  #("webkit_box_reflect", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("webkit_box_reflect", "var(--" <> variable <> ")")
}