...
pub type MsScrollbarDarkshadowColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn ms_scrollbar_darkshadow_color(value: MsScrollbarDarkshadowColor) -> #(String, String) {
  #("-ms-scrollbar-darkshadow-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("ms_scrollbar_darkshadow_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("ms_scrollbar_darkshadow_color", "var(--" <> variable <> ")")
}