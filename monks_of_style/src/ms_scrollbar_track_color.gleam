...
pub type MsScrollbarTrackColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn ms_scrollbar_track_color(value: MsScrollbarTrackColor) -> #(String, String) {
  #("-ms-scrollbar-track-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn var(variable: String) -> #(String, String) {
  #("ms_scrollbar_track_color", "var(--" <> variable <> ")")
}