...
pub type MozBorderBottomColors{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn moz_border_bottom_colors(value: MozBorderBottomColors) -> #(String, String) {
  #("-moz-border-bottom-colors", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("moz_border_bottom_colors", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("moz_border_bottom_colors", "var(--" <> variable <> ")")
}