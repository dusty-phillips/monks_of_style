...
pub fn border_inline_start(value: BorderInlineStart) -> #(String, String) {
  #("border-inline-start", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn var(variable: String) -> #(String, String) {
  #("border_inline_start", "var(--" <> variable <> ")")
}