...
pub fn border_image_source(value: BorderImageSource) -> #(String, String) {
  #("border-image-source", case value {
    None -> "none"
    Ltr -> "ltr"
    Rtl -> "rtl"
    Srgb -> "srgb"
...
pub fn var(variable: String) -> #(String, String) {
  #("border_image_source", "var(--" <> variable <> ")")
}