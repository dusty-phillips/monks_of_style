...
pub type MsScrollbarHighlightColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn ms_scrollbar_highlight_color(value: MsScrollbarHighlightColor) -> #(String, String) {
  #("-ms-scrollbar-highlight-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("ms_scrollbar_highlight_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("ms_scrollbar_highlight_color", "var(--" <> variable <> ")")
}