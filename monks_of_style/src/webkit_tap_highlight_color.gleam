...
pub type WebkitTapHighlightColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn webkit_tap_highlight_color(value: WebkitTapHighlightColor) -> #(String, String) {
  #("-webkit-tap-highlight-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("webkit_tap_highlight_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("webkit_tap_highlight_color", "var(--" <> variable <> ")")
}