...
pub type MsScrollbar3dlightColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn ms_scrollbar_3dlight_color(value: MsScrollbar3dlightColor) -> #(String, String) {
  #("-ms-scrollbar-3dlight-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("ms_scrollbar_3dlight_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("ms_scrollbar_3dlight_color", "var(--" <> variable <> ")")
}