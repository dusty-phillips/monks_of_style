...
pub type MsScrollbarArrowColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn ms_scrollbar_arrow_color(value: MsScrollbarArrowColor) -> #(String, String) {
  #("-ms-scrollbar-arrow-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("ms_scrollbar_arrow_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("ms_scrollbar_arrow_color", "var(--" <> variable <> ")")
}