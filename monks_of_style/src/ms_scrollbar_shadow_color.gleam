...
pub type MsScrollbarShadowColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn ms_scrollbar_shadow_color(value: MsScrollbarShadowColor) -> #(String, String) {
  #("-ms-scrollbar-shadow-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("ms_scrollbar_shadow_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("ms_scrollbar_shadow_color", "var(--" <> variable <> ")")
}