...
pub type WebkitBorderBeforeColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn webkit_border_before_color(value: WebkitBorderBeforeColor) -> #(String, String) {
  #("-webkit-border-before-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn raw(value: String) -> #(String, String) {
  #("webkit_border_before_color", value)
}

pub fn var(variable: String) -> #(String, String) {
  #("webkit_border_before_color", "var(--" <> variable <> ")")
}