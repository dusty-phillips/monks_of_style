...
pub type WebkitTextStrokeColor{
  None
  Srgb
  SrgbLinear
  DisplayP3
...
pub fn webkit_text_stroke_color(value: WebkitTextStrokeColor) -> #(String, String) {
  #("-webkit-text-stroke-color", case value {
    None -> "none"
    Srgb -> "srgb"
...
pub fn var(variable: String) -> #(String, String) {
  #("webkit_text_stroke_color", "var(--" <> variable <> ")")
}